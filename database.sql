...
INSERT INTO "characters" 
	...
	('dragon yellow', 50, 70, 50, 'bone swing', 50, 15, '', '', ''),
	('flam 2', 85, 40, 10, 'slap', 55, 15, '', '', ''),
	('slime 1', 40, 60, 60, 'lick', 50, 20, '', '', ''),
	('slime 2', 55, 60, 50, 'hammer bash', 45, 10, '', '', ''),
	('slime 3', 20, 25, 65, 'chomp', 65, 10, '', '', ''),
	('slime 4', 55, 35, 20, 'fireball', 75, 15, '', '', ''),
	('snake 1', 100, 25, 5, 'body slam', 45, 10, '', '', ''),
	('snake 2', 100, 55, 70, 'headbutt', 10, 10, '', '', ''),
	('snake 3', 160, 50, 60, 'slap', 15, 10, '', '', ''),
	('snake 4', 180, 50, 30, 'cane wack', 20, 15, '', '', ''),
	('eye 1', 170, 50, 85, 'banana shot', 55, 10, '', '', ''),
	('eye 2', 190, 60, 60, 'ice blast', 35, 10, '', '', ''),
	('skull blue', 210, 50, 50, 'arm bar', 50, 10, '', '', ''),
	('skull', 240, 100, 75, 'stomp', 20, 10, '', '', ''),
	('spirit 1', 300, 70, 10, 'giant punch', 35, 10, '', '', ''),
	('spirit 2', 80, 60, 85, 'punch', 150, 25, '', '', ''),
	('octapus 1', 250, 150, 50, 'upper cut', 40, 20, '', '', ''),
	('octapus 2', 180, 100, 100, 'stab', 35, 10, '', '', ''),
	('lantern red', 280, 65, 10, 'belly flop', 45, 10, '', '', '');
	('mushroom 1', 280, 65, 10, 'belly flop', 45, 10, '', '', ''); 
	('mushroom 2', 280, 65, 10, 'belly flop', 45, 10, '', '', ''); 
